...
namespace AuctionLib
{
    ...
    {
        String SqlConnectString = "server=BRIAN-PC;Database=AuctionSite;User id=brian;Password=pass";
        //Data Source=BRIAN-PC;Integrated Security=True;Connect Timeout=15;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False
